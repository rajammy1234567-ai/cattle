...
def index(request):
    ...
    try:
        ...
        banners = [
            {
                'id': 1,
                'title_en': 'Quality Cattle Feed',
                'title_hi': 'गुणवत्ता पशु चारा',
                'description_en': 'Premium cattle feed for healthy livestock',
                'description_hi': 'स्वस्थ पशुओं के लिए प्रीमियम पशु चारा',
                'image_url': '/static/images/banner1.jpg',
                'link_url': '/products/cattle-feed/'
            },
            {
                'id': 2,
                'title_en': 'Best Cattle Medicines',
                'title_hi': 'बेहतरीन पशु दवाएं',
                'description_en': 'Authentic medicines for cattle health',
                'description_hi': 'पशु स्वास्थ्य के लिए प्रामाणिक दवाएं',
                'image_url': '/static/images/banner2.jpg',
                'link_url': '/products/medicines/'
            }
        ]
        mini_slides = [
            {'id': 1, 'image_url': '/static/images/banner1.jpg', 'alt_text': 'Mini 1'},
            {'id': 2, 'image_url': '/static/images/banner2.jpg', 'alt_text': 'Mini 2'},
        ]
        hero_bg = banners[0]['image_url'] if banners and banners[0].get('image_url') else ''
    ...
    try:
        ...
        for p in qs:
            featured_products.append({
                ...
                'final_price': float(p.price * (1 - (p.discount_percentage or 0) / 100)),
        ...
        featured_products = [
            {
                'id': 1,
                'name_en': 'Premium Cattle Feed',
                'name_hi': 'प्रीमियम पशु चारा',
                'description_en': 'High nutrition feed for dairy cattle',
                'description_hi': 'डेयरी पशुओं के लिए उच्च पोषण चारा',
                'price': 1250,
                'discount_percentage': 10,
                'final_price': 1125,
                'image_url': '/static/images/product1.jpg',
                'category': 'Cattle Feed',
                'slug': 'premium-cattle-feed',
                'in_stock': True,
                'variants': [
                    {'weight': '10kg', 'price': 1250},
                    {'weight': '25kg', 'price': 2800}
                ]
            },
            {
                'id': 2,
                'name_en': 'Calcium Supplement',
                'name_hi': 'कैल्शियम सप्लीमेंट',
                'description_en': 'Essential calcium supplement for cattle',
                'description_hi': 'पशुओं के लिए आवश्यक कैल्शियम सप्लीमेंट',
                'price': 450,
    ...
    try:
        ...
        context['feed_types'] = FeedType.objects.filter(is_active=True).order_by('order')
    except Exception:
        pass
    ...
    try:
        ...
        context['videos'] = [
            {
                'id': 1,
                'title_en': 'How to Choose Right Cattle Feed',
                'title_hi': 'सही पशु चारा कैसे चुनें',
                'description_en': 'Learn from experts about choosing the right cattle feed',
                'description_hi': 'विशेषज्ञों से सीखें सही पशु चारा चुनना',
            ...
            {
                'id': 2,
                'title_en': 'Cattle Health Care Tips',
                'title_hi': 'पशु स्वास्थ्य देखभाल टिप्स',
                'description_en': 'Important health care tips for cattle',
                'description_hi': 'पशुओं के लिए महत्वपूर्ण स्वास्थ्य देखभाल टिप्स',
                'youtube_url': 'https://www.youtube.com/embed/dQw4w9WgXcQ',
        ...
        products = [
            {
                ...
                'short_description': 'High nutrition feed for dairy cattle',
                'price': 1250,
                'discount_percentage': 10,
                'final_price': 1125,
                'image_url': '/static/images/product1.jpg',
...
def product_detail(request, slug):
    try:
        ...
        product = {
            'id': 1,
            'name': 'Premium Cattle Feed',
            'long_description': 'High nutrition feed for dairy cattle. Contains essential vitamins and minerals.',
            'price': 1250,
            'discount_percentage': 10,
            'final_price': 1125,
            'image_url': '/static/images/product1.jpg',
            'image_gallery': ['/static/images/product1.jpg', '/static/images/product1-2.jpg'],
            'category': {'name': 'Cattle Feed', 'slug': 'cattle-feed'},
